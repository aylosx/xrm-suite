...
using WebHooks.Functions.Note;

[assembly: FunctionsStartup(typeof(Dataverse.WebHooks.Startup))]
namespace Dataverse.WebHooks
{
    public class Startup : FunctionsStartup
    {
        ...
        public override void ConfigureAppConfiguration(IFunctionsConfigurationBuilder builder)
        {
            ...
            builder.ConfigurationBuilder
                ...
                //.AddJsonFile(Path.Combine(context.ApplicationRootPath, $"appsettings.{context.EnvironmentName}.json"), optional: false, reloadOnChange: true)
