namespace WebHooks.Functions.Note
{
    ...
    public class HandleFileDeletionUponDelete : DataverseWebHook
    {
        #region Constructors
        ...
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "web-hooks/annotation/handle-file-deletion")] HttpRequestMessage req)
        {
