namespace WebHooks.Functions.Note
{
    ...
    public class HandleFileUploadUponCreate : DataverseWebHook
    {
        #region Constructors

        public HandleFileUploadUponCreate(IHttpClientFactory httpClientFactory, ICrmService crmService, IOrganizationService organizationService, ILoggerFactory loggerFactory) 
        ...
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "web-hooks/annotation/handle-file-upload")] HttpRequestMessage req)
        {
        ...
        protected override void Execute()
        {
            ...
            using (FileHandlingService ??= new FileHandlingService(HttpClient, CrmService, OrganizationService, RemoteExecutionContext, LoggerFactory))
            {
                ...
                FileHandlingService.HandleFileUpload(HttpRequestMessage);
