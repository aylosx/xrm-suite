namespace WebHooks.Functions.Account
{
    ...
    public class DoSomethingUponCreate : DataverseWebHook
    {
        #region Constructors

        public DoSomethingUponCreate(ICrmService crmService, IOrganizationService organizationService, ILoggerFactory loggerFactory) 
        ...
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "web-hooks/account/do-something-upon-create")] HttpRequestMessage req)
        {
