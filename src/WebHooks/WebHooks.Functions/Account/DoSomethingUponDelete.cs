namespace WebHooks.Functions.Account
{
    ...
    public class DoSomethingUponDelete : DataverseWebHook
    {
        #region Constructors

        public DoSomethingUponDelete(ICrmService crmService, IOrganizationService organizationService, ILoggerFactory loggerFactory) 
        ...
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "web-hooks/account/do-something-upon-delete")] HttpRequestMessage req)
        {
