namespace WebHooks.Functions.Account
{
    ...
    public class DoSomethingUponRetrieve : DataverseWebHook
    {
        #region Constructors
        ...
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "web-hooks/account/do-something-upon-retrieve")] HttpRequestMessage req)
        {
