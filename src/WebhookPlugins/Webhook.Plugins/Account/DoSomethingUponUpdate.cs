namespace Webhook.Plugins.Account
{
    ...
    public class DoSomethingUponUpdate : DataverseWebhookPlugin
    {
        #region Constructors
        ...
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "webhook/plugins/account/do-something-upon-update")] HttpRequestMessage req)
        {
