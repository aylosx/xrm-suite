namespace Webhook.Plugins.Account
{
    ...
    public class DoSomethingUponDelete : DataverseWebhookPlugin
    {
        #region Constructors

        public DoSomethingUponDelete() { }

        [ActivatorUtilitiesConstructor]
        public DoSomethingUponDelete(ICrmService crmService, ServiceClient serviceClient, ILoggerFactory loggerFactory) 
        ...
        public const string PluginMessageName = PlatformMessageHelper.Delete;
        ...
        [FunctionName("Account_DoSomethingUponDelete")]
        public async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "webhook/plugins/account/do-something-upon-delete")] HttpRequestMessage req)
        {
