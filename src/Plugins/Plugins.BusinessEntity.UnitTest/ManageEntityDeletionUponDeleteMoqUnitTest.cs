namespace Plugins.BusinessEntity.UnitTest
{
    ...
    [TestClass]
    public class ManageEntityDeletionUponDeleteMoqUnitTest : CustomPluginUnitTest<ManageEntityDeletionUponDelete>
    {
        ...
        public override void SetupMockObjectsForPlugin()
        {
            ...
            var mdesMock = new Mock<ManageDeleteEntityService>(Plugin.CrmService, Plugin.OrganizationServiceContext, Plugin.PluginExecutionContext, Plugin.TracingService).SetupAllProperties();
            Plugin.ManageDeleteEntityService = mdesMock.Object;
        }
