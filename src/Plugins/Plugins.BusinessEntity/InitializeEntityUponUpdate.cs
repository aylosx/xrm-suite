namespace Plugins.BusinessEntity
{
    ...
    /// <summary>
    /// Initializes the entity upon update. 
    /// </summary>
    public class InitializeEntityUponUpdate : CustomPlugin
    {
        #region Constructors

        /// <summary>
        /// InitializeEntityUponUpdate plug-in constructor used to 
        /// initialize the context variables.
        /// </summary>
        public InitializeEntityUponUpdate()
        {
        ...
        public override void Validate()
        {
            ...
            if (PluginExecutionContext.MessageName != PlatformMessageHelper.Update)
            {
                throw new InvalidPluginExecutionException(string.Format(CultureInfo.InvariantCulture,
                    TraceMessageHelper.IncorrectMessageName, UnderlyingSystemTypeName,
                    PlatformMessageHelper.Update, PluginExecutionContext.MessageName));
            }
