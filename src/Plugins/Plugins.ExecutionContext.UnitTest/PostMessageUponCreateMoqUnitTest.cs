namespace Plugins.ExecutionContext.UnitTest
{
    ...
    [TestClass]
    public class PostMessageUponCreateMoqUnitTest : CustomPluginUnitTest<PostMessageUponCreate>
    {
        ...
        public override void SetupMockObjectsForPlugin()
        {
            ...
            var pmsMock = new Mock<PostMessageService>(Plugin.CrmService, Plugin.OrganizationServiceContext, Plugin.PluginExecutionContext, Plugin.TracingService).SetupAllProperties();
            Plugin.PostMessageService = pmsMock.Object;
        }
