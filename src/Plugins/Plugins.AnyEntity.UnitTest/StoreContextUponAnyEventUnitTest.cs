namespace Plugins.AnyEntity.UnitTest
{
    ...
    [TestClass]
    public class StoreContextUponAnyEventUnitTest : CustomPluginUnitTest<StoreContextUponAnyEvent>
    {
        ...
        {
            Plugin.OrganizationServiceContext = MockRepository.GenerateStub<CrmServiceContext>(Plugin.OrganizationService);
            Plugin.CrmService = MockRepository.GenerateMock<CrmService>(Plugin.OrganizationServiceContext, Plugin.TracingService);
            Plugin.ManageExecutionContext = MockRepository.GenerateMock<ManageExecutionContext>(Plugin.CrmService, Plugin.OrganizationServiceContext, Plugin.PluginExecutionContext, Plugin.TracingService);
        }
