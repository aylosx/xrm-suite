namespace Aylos.Xrm.Sdk.BuildTools.DeleteSolution
{
    ...
    public sealed class DeleteSolutionApp : ConsoleApp
    {
        static void Main(string[] args)
        {
            DeleteSolutionApp app = new DeleteSolutionApp();
            ...
            try
            {
                ...
                {
                    solutionService.DeleteSolution(options.SolutionName);
