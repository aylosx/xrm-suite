namespace Aylos.Xrm.Sdk.BuildTools.RemoveSolutionComponent
{
    ...
    public sealed class RemoveSolutionComponentApp : ConsoleApp
    {
        static void Main(string[] args)
        {
            RemoveSolutionComponentApp app = new RemoveSolutionComponentApp();
            ...
            try
            {
                ...
                {
                    solutionService.RemoveSolutionComponent(options.SolutionName, options.ComponentId, options.ComponentType);
