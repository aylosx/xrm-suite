namespace Aylos.Xrm.Sdk.BuildTools.ExportSolution
{
    ...
    public sealed class ExportSolutionApp : ConsoleApp
    {
        static void Main(string[] args)
        {
            ExportSolutionApp app = new ExportSolutionApp();
            ...
            try
            {
                ...
                {
                    solutionService.ExportSolutions(options.SolutionName, options.SolutionType, options.OutputPath, options.IncludeVersion.GetValueOrDefault());
