...
REM crmsvcutil.exe /namespace:"Aylos.Xrm.Sdk.BuildTools.Models.Domain" /out:"CrmServiceContext.cs" /servicecontextname:"CrmServiceContext" /url:"https://aylos.crm11.dynamics.com/xrmservices/2011/organization.svc" /username:%1 /password:%2 /domain:%3 > CrmSvcUtil.exe.output.log

REM Use the below command for D365 Online
crmsvcutil.exe /namespace:"Aylos.Xrm.Sdk.BuildTools.Models.Domain" /out:"CrmServiceContext.cs" /servicecontextname:"CrmServiceContext" /interactivelogin:true > CrmSvcUtil.exe.output.log
