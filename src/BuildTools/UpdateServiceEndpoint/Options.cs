namespace Aylos.Xrm.Sdk.BuildTools.UpdateServiceEndpoint
{
    ...
    public class Options : CommandLineOptions
    {
        ...
        [Option("primaryKey", Required = true, HelpText = "Specifies the primary key of the service endpoint.")]
        public string PrimaryKey { get; set; }

        [Option("namespaceAddress", Required = true, HelpText = "Specifies the namespace address of the service endpoint.")]
        public string NamespaceAddress { get; set; }

        [Option("sharedAccessKey", Required = true, HelpText = "Specifies the shared access key of the service endpoint.")]
        public string SharedAccessKey { get; set; }

        [Option("serviceNamespace", Required = true, HelpText = "Specifies the service namespace of the service endpoint.")]
